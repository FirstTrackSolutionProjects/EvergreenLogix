    ...
    <>
      ...
      <div className="h-full flex">
        ...
        <button
          ...
          className="md:hidden p-2.5 fixed top-[65px] left-3 text-white hover:text-red-500 hover:bg-white transition-colors duration-200 z-[40] bg-red-500 rounded-xl shadow-lg backdrop-blur-md border border-white/10"
          ...
          {isOpen && (
            <div className="flex items-center px-6 py-6 border-b border-gray-800/50 mb-2">
              ...
              <span className="ml-3 text-lg font-extrabold text-white whitespace-nowrap">
                Evergreen <span className="text-[#22c55e]">Logix</span>
              </span>
            </div>
          )}
          <ul className="p-4">
